...
export default function RoleAccessPage() {
  ...
  const pages = [
      ...
      items: [
        { key: "dashboard", label: "Dashboard" },
        {
          ...
          items: [
            ...
            { key: "create-campaign", label: "Create Campaign" },
        ...
        },
        {
          ...
          items: [
            ...
            { key: "config-template", label: "Configure Template" },
            { key: "email-template", label: "Email Templates" },
            { key: "manage-categories", label: "Manage Categories" },
          ],
        },
        {
          category: "Logs",
        ...
        },
        {
          ...
          items: [
            ...
            { key: "email-configuration", label: "Email Configuration" },
          ],
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          category: "Personal Block",
          items: [{ key: "appsflyer-dashboard", label: "Appsflyer Dashboard" }],
        },
      ],
    },
  ];

  const togglePermission = (pageKey: string, roleId: number | string) => {
    setPermissions((prev) => ({
      ...prev,
      [pageKey]: {
        ...prev[pageKey],
        [roleId]: !prev[pageKey]?.[roleId],
      },
    }));
  };
  ...
  const handleCreateRole = () => {
    if (newRoleName.trim()) {
      ...
      setRoles([...roles, { id: newRoleId, name: newRoleName }]);
              ...
              <TableCell key={`${item.key}-${role.id}`} className="text-center">
                <div className="flex items-center justify-center">
                  <Checkbox
                    ...
                    onCheckedChange={() => togglePermission(item.key, role.id)}
                    className="data-[state=checked]:bg-gradient-to-br data-[state=checked]:from-indigo-500 data-[state=checked]:to-purple-500 data-[state=checked]:border-0 transition-all hover:scale-110"
                  />
                </div>
              </TableCell>
            ))}
